    ...
    <Fragment>
      {
        isLoading ?
                ...
                :
        <Fragment>
        <div className='fixed max-w-[600px] border-0 md:border lg:max-w-[400px] m-auto top-0 bottom-0 left-0 right-0  z-10 bg-black opacity-60'></div>
        <div className="fixed max-w-[600px] border-0 md:border lg:max-w-[400px] m-auto left-0 right-0 top-0 bottom-0 z-50 bg-white ">
...
<Fragment>
{
    ...
    <Fragment>
         <div className='fixed max-w-[600px] lg:max-w-[400px] m-auto top-0 bottom-0 left-0 right-0  z-10 bg-black opacity-60'></div>
        <div className="fixed max-w-[600px] lg:max-w-[400px] m-auto left-0 right-0 top-0 bottom-0 z-40 bg-white ">
            <div className=' flex items-center justify-center m-auto  w-[100%] '>
                      ...
                      <div className='flex flex-col gap-2  w-[100%] font-semibold text-[16px]'>
                            ...
                            <div className="w-[100%] flex items-center gap-5 rounded-[10px] border-[#162449] border p-4 ">
                              ...
                              <label htmlFor='coverimage' className='p-5 relative flex items-center justify-center w-[100%]'>
                                {photo ? 
                                <div className='relative w-[200px] h-[160px] rounded-full'>
                                   <img src={photo} alt='Cover Image...' className='relative w-[150px] m-auto h-[150px] rounded-full'/>
                                   {uploading ?
